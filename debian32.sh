...
sed -i 's/port 1194/port 2020/g' /etc/openvpn/1194.conf
...
sed -i 's/1194/2020/g' /etc/openvpn/1194-client.ovpn
...
echo "Fail2Ban : [on]"
echo "IPv6     : [off]"
echo "Status   : Taip ./status utk check status user"
echo ""
echo "Sila Reboot VPS Anda !"
echo ""
echo
echo "Gunakan dengan berhemah/No Porn/Ddos Attack !!" "==============================================="
